    ...
    return (
        <Flex direction="column">
            ...
            <Flex direction="column">
                ...
                <Input onInput={props.setValue} type={props.type} placeholder={props.placeholder} autocomplete="off" padding="0 0 0 0" width="300px" color="white" bgColor="transparent" border="none" />
            </Flex>
        </Flex>
    )
}
